...
public class TransactionEndpointIntegrationTests : IClassFixture<CustomWebApplicationFactory<Program>>, IDisposable
{
    ...
    [Fact(DisplayName = "POST /api/v1/transactions/create for an is null or white space x-user-identification header value should return HTTP 400 Bad Request.")]
    ...
    [Fact(DisplayName = "POST /api/v1/transactions/create for an invalid transaction value should return HTTP 400 Bad Request.")]
    ...
    [Fact(DisplayName = "POST /api/v1/transactions/create for an no-existent category should return HTTP 400 Bad Request.")]
